...
ASaiM framework relies mainly on a :ref:`configuration file <for-devs-configuration-file>` describing the generated pipeline. This pipeline is then executed by call of the different chosen modules, submodules and tools. These calls and the interface between the different tools is made with ``Python`` scripts and modules.
